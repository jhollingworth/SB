...
namespace SwanBob.Web.Controllers
{
    public class RouteRegistrar
    {
        public static void RegisterRoutesTo(RouteCollection routes)
        {
            ...
            //routes.CreateArea("Organization/Department", "SwanBob.Web.Controllers.Organization.Department",
            ...
            //);
            //routes.CreateArea("Organization", "SwanBob.Web.Controllers.Organization",
            ...
            routes.CreateArea("Root", "SwanBob.Web.Controllers",
